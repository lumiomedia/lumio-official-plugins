...
const EN = {
  ...
  modeGrid: 'Grid',
  // Den städade guiden (skrivbord/TV): tre lägen, käll-/kategoriväljare, zoom.
  modeNowNext: 'Now / Next',
  modeTimelineDay: 'Timeline',
  zoom2h: '2 h',
  zoom6h: '6 h',
  zoomDay: 'Whole day',
  details: 'Details',
  sourceAll: 'All playlists',
  ...
  // Grid i den städade guiden (Task 3): kollapsade tomma rader, pagineringsrad, detaljpanel.
  noEpgRow: 'No guide for this channel · broadcasting live',
  ...
  // Biblioteksläget: VOD som en källa bland Plex, Jellyfin och egna mappar.
  vodLibraryHeading: 'Use as library',
  vodLibraryHint: 'Build a library index from the film and series in this playlist. The library can then own the home page, the same way Plex and Jellyfin can.',
  vodLibraryBuild: 'Build library',
  vodLibraryRebuild: 'Rebuild',
  vodLibraryBuilding: 'Building… {count} titles',
  vodLibraryNotBuilt: '{count} titles ready to index',
  vodLibraryBuilt: '{count} titles in the library',
  vodLibraryImporting: 'The playlist is still importing — wait until it finishes.',
  vodLibraryScanning: 'A library scan is already running.',
  vodLibraryWhereToEnable: 'Turn it on under Settings → Home → Start page.',
  vodLibraryFailed: 'Could not build the library: {error}',
  // Hubben
...
const SV: Record<keyof typeof EN, string> = {
  ...
  modeGrid: 'Rutnät',
  modeNowNext: 'Nu / Sen',
  modeTimelineDay: 'Tablå',
  zoom2h: '2 h',
  zoom6h: '6 h',
  zoomDay: 'Hela dagen',
  details: 'Detaljer',
  sourceAll: 'Alla spellistor',
  categoryAll: 'Alla kategorier',
  pickSource: 'Spellista',
  ...
  noEpgRow: 'Ingen tablå för den här kanalen · sänder live',
  ...
  epgFromPlaylist: 'Från spellistan',
  epgAutoOff: 'Stäng av',
  ...
  vodLibraryHeading: 'Använd som bibliotek',
  vodLibraryHint: 'Bygg ett biblioteksindex av filmerna och serierna i spellistan. Biblioteket kan sedan äga startsidan, på samma sätt som Plex och Jellyfin kan.',
  vodLibraryBuild: 'Bygg bibliotek',
  vodLibraryRebuild: 'Bygg om',
  vodLibraryBuilding: 'Bygger… {count} titlar',
  vodLibraryNotBuilt: '{count} titlar redo att indexeras',
  vodLibraryBuilt: '{count} titlar i biblioteket',
  vodLibraryImporting: 'Spellistan importeras fortfarande — vänta tills den är klar.',
  vodLibraryScanning: 'En genomgång pågår redan.',
  vodLibraryWhereToEnable: 'Slå på det under Inställningar → Hem → Startsida.',
  vodLibraryFailed: 'Kunde inte bygga biblioteket: {error}',
